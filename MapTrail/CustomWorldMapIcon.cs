...
namespace MapTrail
{
    public class CustomWorldMapIcon
    {
        ...
        public CustomWorldMapIconType Type;
        public WorldMapIconType NormalType;
        public Vector3 Position;
        public Vector3 Scale = new Vector3(4, 4, 1);
        public bool IsSecret;

        public CustomWorldMapIcon(CustomWorldMapIconType type, Vector3 position, MoonGuid guid)
        {
            Guid = guid;
            Type = type;
            Position = position;
        ...
        public CustomWorldMapIcon(WorldMapIconType type, Vector3 position, MoonGuid guid)
        {
            Guid = guid;
            Type = CustomWorldMapIconType.None;
            NormalType = type;
            Position = position;
        }
    }
    ...
    public class AreaMapIconManagerCustomIcons
    {
        ...
        private static void AddIcons(RuntimeGameWorldArea runtimeGameWorldArea)
        {
            foreach (var icon in CustomWorldMapIconManager.Icons)
            {
                ...
                bool collected = false; // RandomizerLocationManager.IsPickupCollected(icon.Guid);
    ...
    public class RuntimeWorldMapIconCustomShow
    {
        ...
        private static GameObject CreateIcon(RuntimeWorldMapIcon instance)
        {
            if (CustomWorldMapIconManager.iconMap.ContainsKey(instance.Guid))
            {
                ...
                if (customIcon.Type == CustomWorldMapIconType.None)
                {
